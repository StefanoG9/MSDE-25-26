...
├── progetto_msde.html          # Report renderizzato
├── serie_macro_fred.xlsx       # Dataset
└── images/                     # Grafici generati dal report
    ├── plot-overview-1.png
    ├── decomposition-1.png
    ├── acf-pacf-prod-1.png
    ├── diagnostica-arima-1.png
    ├── forecast-arima-1.png
    ├── ccf-analysis-1.png
    ├── tfm-whitened-ccf-1.png
    ├── tfm-diagnostics-1.png
    ├── var-residual-plots-1.png
    ├── var-forecast-1.png
    ├── fevd-analysis-1.png
    ├── irf-analysis-{1,2,3}.png
    ├── irf-selected-1.png
    ├── engle-granger-1.png
    └── ...
```
...
2. Assicurarsi che il file `serie_macro_fred.xlsx` sia nella stessa cartella del file `.qmd`.
